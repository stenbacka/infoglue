 ...
 *
 */
public class BoundContentsWithSupplementingAssetTag extends ComponentLogicTag
{
	...
	public int doEndTag() throws JspException
    {
        if(siteNodeId == null)
        {
        		setResultAttribute(getComponentLogic().getBoundContentsWithSupplementingAsset(propertyName, useInheritance, useRepositoryInheritance, useStructureInheritance));
        }
        else
        {
