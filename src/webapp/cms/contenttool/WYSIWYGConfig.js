...
function overrideLabels()
{
	...
	{
		FCKLang.DlgBtnBrowseServer = "V�lj fr�n InfoGlue...";
		FCKLang.DlgImgBtnUpload = "Ladda upp till InfoGlue";
		FCKLang.DlgLnkBtnUpload = "Ladda upp till InfoGlue";
	    FCKLang.DlgImgURL = "URL (gl�m ej http:// om du anger extern URL)";
	    FCKLang.DlgLnkURL = "URL (gl�m ej http:// om du anger extern URL)";
	}
	else
	{
